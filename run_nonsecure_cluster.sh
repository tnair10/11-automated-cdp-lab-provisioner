...
RESULTS="$ROOT/results/p11-live/nonsecure"
mkdir -p "$RESULTS"

echo "========================================"
echo " PROJECT 11 NON-SECURE CLUSTER"
echo "========================================"
...
"$INFRA" plan nonsecure

"$INFRA" apply nonsecure
...
"$INFRA" idempotency nonsecure \
  2>&1 | tee "$RESULTS/terraform-idempotency.log"

echo
echo "========================================"
echo " NON-SECURE CLUSTER: PASS"
echo "========================================"
